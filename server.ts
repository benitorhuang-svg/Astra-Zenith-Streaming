...
// Atomic Core & Routes
import { PORT } from './server/core/config';
import { pool } from './server/models/Agent';
...
import { syncMultimodalKnowledge } from './server/services/CoreService';
...
app.listen(PORT, '0.0.0.0', async () => {
    ...
    console.log(`📁 AZ Directory: ${azDir} (Exists: ${fs.existsSync(azDir)})`);
