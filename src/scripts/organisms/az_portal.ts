...
export class AZPortal extends HTMLElement {
    ...
    connectedCallback() {
        ...
        window.addEventListener('mousedown', (e) => {
            if (!this.selectedAgentInfo) return;
        ...
        if (!this.querySelector('.u-portal-wrapper')) {
            this.innerHTML = `
                ...
                <div class="u-portal-wrapper flex w-full h-full overflow-hidden px-3 pb-3 relative"
                    ...
                    <div id="u-portal-sidebar" class="w-[100px] h-full bg-black/40 backdrop-blur-3xl border-r border-white/5 relative z-10 transition-all duration-500"></div>
                    <div id="u-portal-main" class="flex-1 h-full relative z-10"></div>
