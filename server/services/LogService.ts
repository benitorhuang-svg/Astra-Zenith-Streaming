...
export function pushLog(message: string, type: string = 'info', metadata?: any) {
...
export function registerLogClient(res: Response) {
...
export function unregisterLogClient(res: Response) {
    clients.delete(res);
}
