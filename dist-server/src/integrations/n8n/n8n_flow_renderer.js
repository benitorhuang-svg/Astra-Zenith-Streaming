...
exports.renderN8NFlowChart = void 0;
/**
 ...
 */
const renderFluxPath = (d, isCoreAxis) => `
    <!-- 1. GHOST CHANNEL -->
    ...
    ` : ''}
`;
const renderN8NFlowChart = (topology = 'linear', n8nFlow) => {
    let result;
    if (topology === 'orbital') {
        const CY = 290;
        const CX = 650;
