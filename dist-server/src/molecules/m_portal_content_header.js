...
exports.renderCommonHeader = void 0;
const renderCommonHeader = (opts) => {
    const { title, modeIcon = '', accentColor = 'var(--color-primary)', showControl = false, leftExtra = '', rightExtra = '' } = opts;
    return `
...
exports.renderCommonHeader = renderCommonHeader;
