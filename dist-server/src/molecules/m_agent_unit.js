...
exports.AZAgentUnit = void 0;
const agents_1 = require("../core/agents");
class AZAgentUnit extends HTMLElement {
    ...
    render() {
        ...
        const agent = agents_1.AGENT_POOL.find(a => a.code === code);
        if (!agent) {
        ...
        if (originSeat)
            this.setAttribute('data-origin-seat', originSeat);
        this.innerHTML = `
            ${isVertical ? `
...
exports.AZAgentUnit = AZAgentUnit;
