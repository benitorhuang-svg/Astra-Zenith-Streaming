...
exports.renderLiveTelemetry = renderLiveTelemetry;
exports.renderRoundFilters = renderRoundFilters;
exports.renderCycleController = renderCycleController;
exports.renderPassSequenceHorizontal = renderPassSequenceHorizontal;
exports.renderStatusTelemetry = renderStatusTelemetry;
/**
 * Live Telemetry display (e.g., 0 / 5)
 */
function renderLiveTelemetry(currentPasses, pollingCycles) {
    return `
 ...
 */
function renderRoundFilters(pollingCycles, currentPasses, filterRound = 'all') {
    return `
 ...
 */
function renderCycleController(pollingCycles) {
    return `
 ...
 */
function renderPassSequenceHorizontal(pollingCycles, currentPasses, filterRound = 'all') {
    return `
 ...
 */
function renderStatusTelemetry(currentPasses, _pollingCycles) {
    return `
