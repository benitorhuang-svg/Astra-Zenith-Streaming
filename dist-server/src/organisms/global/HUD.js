...
exports.AZHUD = void 0;
class AZHUD extends HTMLElement {
    isOpen = false;
    data = {
        title: 'UNIT',
        code: 'node_id',
    ...
    connectedCallback() {
        this.render();
        window.addEventListener('az-open-hud', (e) => this.open(e.detail));
        ...
        setTimeout(() => {
            ...
            if (drillBtn) {
                drillBtn.addEventListener('click', () => {
                    const input = document.getElementById('u-mission-input');
                    if (input) {
