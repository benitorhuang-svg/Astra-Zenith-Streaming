 ...
 */
function cacheSeatRects(hostElement) {
...
function initiateCustomDrag(e, agent, originSeatIndex) {
    // 1. Snapshot State
...
function handlePointerMove(e, drag) {
    ...
    if (snappedIndex !== drag.snappedIndex) {
        ...
        if (snappedIndex >= 0) {
            ...
            if (seatEl)
                seatEl.classList.add('u-drag-over');
        }
...
function handlePointerUp(drag, participants, onCommit, onClear, onCancel) {
