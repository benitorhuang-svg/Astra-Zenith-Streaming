...
exports.renderDecisionTreeView = void 0;
const m_portal_content_footer_1 = require("../../../molecules/m_portal_content_footer");
const renderDecisionTreeView = (messages, isStreaming) => {
    const nodes = window.semanticNodes || [];
    const links = window.semanticLinks || [];
    const hasGraphData = nodes.length > 0;
    const shouldRenderGraph = hasGraphData || isStreaming || window.ZENITH_PREVIEW_MODE;
...
exports.renderDecisionTreeView = renderDecisionTreeView;
