...
exports.renderTelemetryView = void 0;
...
const renderTelemetryView = (telemetry) => {
    ...
    return `
        <div class="u-portal-chat-container flex flex-col h-full overflow-hidden">
            ${(0, m_portal_content_header_1.renderCommonHeader)({
...
exports.renderTelemetryView = renderTelemetryView;
/**
 * MOLECULE: Telemetry Tile
 */
function renderTelemetryTile(title, value, color, subtitle) {
    return `
