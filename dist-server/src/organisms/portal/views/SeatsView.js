...
exports.renderSeatsView = void 0;
...
const renderSeatsView = (tableParticipants = [], agentPool, currentTopology = 'linear', n8nFlow, justLandedIndex = null, modelConfigs = [], isEditingTask = false, activePrompt = '') => {
    ...
    return `
            ...
            <div class="flex-1 relative overflow-hidden flex items-center justify-center p-4">
                ...
                <div class="absolute left-1/2 top-1/2 w-[1300px] h-[600px] -translate-x-1/2 -translate-y-1/2 origin-center transition-all duration-500 pointer-events-auto scale-[0.6] md:scale-[0.7] lg:scale-[0.8] xl:scale-[0.85] 2xl:scale-[1]">
                    ...
                    <div class="absolute inset-0 z-10 pointer-events-none">
                        ${(0, n8n_flow_renderer_1.renderN8NFlowChart)(currentTopology, n8nFlow)}
                    </div>
        ...
        return (0, TableComponent_1.renderAgentSeat)(i, agent, currentTopology, i === justLandedIndex, customPos, null, '', modelName);
    }).join('')}
                    </div>
                </div>
...
exports.renderSeatsView = renderSeatsView;
function renderOrchestrationFooter(agentPool, tableParticipants, currentTopology) {
    const pooledAgents = agentPool.filter(a => !tableParticipants.includes(a.code));
    const limit = 6;
    return (0, m_portal_content_footer_1.renderCommonFooter)({
        containerClass: 'px-0',
        left: `
