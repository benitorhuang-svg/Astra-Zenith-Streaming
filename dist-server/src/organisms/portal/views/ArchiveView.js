...
exports.renderArchiveView = void 0;
const m_portal_content_header_1 = require("../../../molecules/m_portal_content_header");
const m_portal_content_footer_1 = require("../../../molecules/m_portal_content_footer");
const renderArchiveView = (archives = [], selectedId = null, billingTier = 'FREE') => {
    const selectedArch = selectedId ? archives.find(a => a.id === selectedId) : archives[0];
    const isPaid = billingTier === 'PAID';
    const header = (0, m_portal_content_header_1.renderCommonHeader)({
        title: '任務歸檔：離線數據歸檔庫',
...
exports.renderArchiveView = renderArchiveView;
