...
exports.TelemetryMonitor = void 0;
...
class TelemetryMonitor {
    ...
    syncLocalState() {
        ...
        const tokenCount = this.context.messages.reduce((sum, m) => sum + (0, utils_1.estimateApproximateTokens)(m.content), 0);
        const p = this.context._p;
        p.telemetryState = {
            ...p.telemetryState,
...
exports.TelemetryMonitor = TelemetryMonitor;
