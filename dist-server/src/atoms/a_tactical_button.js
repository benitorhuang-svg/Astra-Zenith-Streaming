...
exports.AZTacticalButton = void 0;
class AZTacticalButton extends HTMLElement {
    button = null;
    ...
    set loading(val) { if (val)
        this.setAttribute('loading', '');
    else
        this.removeAttribute('loading'); }
    get disabled() { return this.hasAttribute('disabled'); }
    set disabled(val) { if (val)
    ...
    render() {
        ...
        this.style.width = size === 'lg' ? '100%' : 'fit-content';
...
exports.AZTacticalButton = AZTacticalButton;
