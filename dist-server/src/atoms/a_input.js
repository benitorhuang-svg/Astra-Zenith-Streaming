...
exports.AZTacticalInput = void 0;
class AZTacticalInput extends HTMLElement {
    ...
    render() {
        ...
        const internalInput = this.querySelector('.az-input-core');
        if (internalInput) {
            internalInput.value = value;
            internalInput.type = type;
            internalInput.placeholder = placeholder;
            if (error)
                internalInput.classList.add('text-red-300');
            else
                internalInput.classList.remove('text-red-300');
            return;
        }
...
exports.AZTacticalInput = AZTacticalInput;
